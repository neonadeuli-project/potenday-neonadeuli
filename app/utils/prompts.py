...
설명 : 정답은 1번 223호이오. 근정전은 경복궁의 중심 건물로, 조선 왕조의 국왕이 공식적으로 업무를 보시던 곳이오.
국보 223호로 지정되어 있으며, 대한민국의 역사와 문화를 대표하는 건축물 중 하나이오.
더 궁금한 것이 있으면 언제든 물어보시오.
'''
